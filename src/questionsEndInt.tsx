...
const items = [
    ...
    { value: "Employer Question 5", title: "As far as first hiring entry level devs what is the most prominent challenge you have seen so I can do my best to avoid making the same pitfall"},
